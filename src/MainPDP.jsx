...
import {Animated, Easing ,Modal,StyleSheet,Text,View,Image,Button, TouchableOpacity, ScrollView,TouchableWithoutFeedback,ActivityIndicator} from 'react-native';
    ...
    { useNativeDriver: false }
      ...
      {/* <Text>here {JSON.stringify(checkproductAvailabilityAtPincode)}</Text> */}
          ...
          <TouchableOpacity
             ...
             style={{top:'-122%',marginRight:'-712%',padding:'4%',}}
            >              
                    <Image source={back}  
                      style={{marginLeft:12}}
                      />
              ...
              <View style={{width:'84%'}}>
                <Text style={{fontSize:12,backgroundColor:'#e8e6e6',marginLeft:'3%'}}>14 days easy return / excahnge applicable for this product
                </Text>
              </View>
                ...
                <View style={{flexDirection:'row',marginLeft:'-1%'}}>
                     ...
                     <View style={{}}>
                       ...
                       <Text style={styles.detail3}>{product.country?.charAt(0).toUpperCase() + product.country?.slice(1)}</Text>
                        <Text style={styles.detail3}>{product.wearType?.charAt(0).toUpperCase() + product.wearType?.slice(1)}</Text>
                        <Text style={styles.detail3}>{product.fabric?.charAt(0).toUpperCase() + product.fabric?.slice(1)}</Text>
                        <Text style={styles.detail3}>{product.sleeves?.charAt(0).toUpperCase() + product.sleeves?.slice(1)}</Text>
                        <Text style={styles.detail3}>{product.fit?.charAt(0).toUpperCase() + product.fit?.slice(1)}</Text>
                        <Text style={styles.detail3}>{product.materialCare?.charAt(0).toUpperCase() + product.materialCare?.slice(1)}</Text>
                     </View>
                </View>
...
<View style={{flexDirection:'row',justifyContent:'space-around',alignItems:'center'}}> 
 ...
 <TouchableOpacity
  ...
  <Image source={bag} style={{width:17,height:21,}}/>
    {
      isProductInBag?
      <Text style={{color:'white',fontWeight:'bold',fontSize:17,}}> Go to Bag  </Text>:
